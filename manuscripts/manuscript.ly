...
\relative {
  ...
  \tempo "Adagio" 2=55
  \override Staff.StaffSymbol.line-positions = #'(9.5 3.25 -3.25 -9.5)
  \time 2/2
  \startStaff \grace { a,8(\f^\markup { \smaller \italic "quasi chitarra" } b' } b'2) \grace { g8( g, } c,2)\> |
  \grace { d'8( f, } e''2) \grace { d8( e,, } e'2)\mp |
  e'8.[-+\pp^\markup { \smaller \italic "gocce di pioggia" } a,,,16_+] \tuplet 5/4 { r8 \grace { g'16( } f8)-+ b'16-+ } r4 \grace d,16( \tuplet 3/2 { e,16)_+ 8_+ } r8 | r16 \grace c''16( e,16-+) b'8-+ r8 r16 c,,16_+ r4 r8 b'8_+ |
  e,8_+ r8 r4 \tuplet 3/2 { r8 r8 f16[_+ e']_+ } r4 | d8[-+ c'8] r8 r16 e16-+ r4
